...
String measure_imu_currents(double &pi_imu_current, double &esp_imu_current, double &pi_current) 
{
  ...
  pi_imu_current = (pi_imu_voltage - 1.65)*(1 / 0.132);
  esp_imu_current = (esp_imu_voltage - 1.65)*(1 / 0.132);

  // (2.5*2)/3 = 1.67 = zero current voltage for pi 
  pi_current = (pi_voltage - 1.67)*pi_sensitivity*(3.3/5.0); 
